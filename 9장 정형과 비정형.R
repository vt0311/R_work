...
# sql 디벨로퍼에서 관리자 권한으로 다음 문장을 실행하시오.
# alter user gomdori identified by oracle account unlock ;
id <- 'gomdori'
password <- 'oracle'
...
query2 = 'select * from country_summary_top_10'
result2 <- dbGetQuery(conn, query2)
class( result2 ) # data.frame
result2


query3 = 'select * from bungi'
